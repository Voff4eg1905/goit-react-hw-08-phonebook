...
export class App extends Component {
  ...
  componentDidMount() {
    const localeStorageInfo = localStorage.getItem('phonebook');
    console.log(localeStorageInfo);
    if (localeStorageInfo) {
      this.setState({ contacts: JSON.parse(localeStorageInfo) });
      return;
    }
